...
![Version](https://img.shields.io/badge/React%20Native%20ClickPay-v1.0.2-green)
...
`$ npm install @clickpay.sa/react-native-clickpay@1.0.2 --save`

## Add the following to android block in build.gradle[app]
