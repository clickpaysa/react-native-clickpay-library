...
configuration.merchantIdentifier = "merchant.clickpaysa.php"
...
configuration.simplifyApplePayValidation = false

let shippingDetails = new PaymentSDKBillingDetails(name= "John Smith",
  ...
  render() {
    return (
      <View style={styles.container}>
        <Text style={styles.welcome}>Demo ClickPay React-Native (CLI)</Text>
